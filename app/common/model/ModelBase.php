...
class ModelBase extends Model
{
     ...
     * 自己加入的简单分页参数
     */
    final protected function getListMy($where = [], $field = true, $order = '', $paginate = 0, $simple = false)
    {
        ...
        if (false === $paginate) {
            ...
            $list = $query->paginate(input('list_rows', $list_rows), $simple, ['query' => request()->param()]);
        }
